...
export default function Word() {
    ...
    useEffect(() => {
        ...
        engx_service.getWordPronunciation(word!).then(
            _pronunciation => setPronunciation(_pronunciation)
        )
        engx_service.getWordDefinition(word!).then(
            _definition => setDefinition(_definition)
        )
        engx_service.getWordExample(word!).then(
